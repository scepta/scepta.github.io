    ...
    <section class="main-banner">
        <div class="container">
          <h1 class="fade-in-up one">
            The Open Source
            <span>Policy Authoring and Execution Platform</span>
          </h1>
          <div class="buttons fade-in two">
            <!--<a class="btn btn-primary btn-lg" href="https://github.com/scepta/scepta">Download Scepta</a>-->
            <a class="btn btn-default btn-lg" href="https://github.com/scepta">View on GitHub</a>
          </div>
...
-->
    <section class="description">
        <p>
            Scepta is a new Open Source policy authoring and execution solution. While it is under heavy development, this is
            also a great time to <a href="/community/join.html" target="_blank">join the discussions</a> and
            why not even <a href="https://github.com/scepta" target="_blank">contribute</a>. We know it's
            very rough at the moment and documentation is coming up but feel free to ask anything on
            <a href="irc://irc.freenode.net/#jbossoverlord" target="_blank">IRC</a> or by 
            <a href="https://community.jboss.org/en/overlord/dev" target="_blank">posting a question</a>.
        </p>
    </section>
    <section class="main-features">
        <div class="container">
            <h2>Scepta Features</h2>
